...
* **Algebraic data, traits, modules.** Structural records and tagged unions, recursive algebraic data types, Rust-style new types over them, traits (type classes) with multi-parameter and associated-type support, row polymorphism, and a `module::name` / `use module::*;` system.
