...
/// Selected member slot of a subscript bundle.
...
impl SubscriptMemberKind {
    pub fn mut_member(self) -> bool {
...
pub enum ProjectionOrigin {
    ...
    Explicit,
    /// Projection was generated by the compiler for structural generic evidence.
    GeneratedStructural,
}
...
pub struct Module {
    ...
    pub(crate) projection_subscripts: FxHashMap<ProjectionKey, ProjectionEntry>,
...
impl Module {
    ...
    pub fn new(module_id: ModuleId, path: Path) -> Self {
        Self {
            ...
            functions: Vec::new(),
            subscripts: Vec::new(),
            projection_subscripts: FxHashMap::default(),
    ...
    pub(crate) fn add_subscript_anonymous(
        &mut self,
        subscript: SubscriptDefinition,
    ) -> LocalSubscriptId {
    ...
    /// Register a projection implementation backed by an existing subscript.
    pub(crate) fn add_projection_subscript(
        &mut self,
        key: ProjectionKey,
        subscript: LocalSubscriptId,
        visibility: Visibility,
        ...
        self.projection_subscripts.insert(
            key,
            ProjectionEntry {
                subscript,
                visibility,
    ...
    /// Get a projection implementation registered in this module.
    pub fn get_projection_subscript(&self, key: ProjectionKey) -> Option<ProjectionEntry> {
        self.projection_subscripts.get(&key).copied()
    }
