...
fn call_functions() {
  ...
  b0:
    ...
    %r4 = call std::Num<std::int>::add#impl:7665d3ee(%p0, %r0, %p1)
    %r5 = ret
"#
    );
  ...
  b0:
    ...
    %r5 = call std::Num<std::int>::mul#impl:a3604103(%r0, %p0, %r1)
    %r6 = move %r1 to %p1
    %r7 = ret
"#
    );
...
"#
  ...
  b4:
    ...
    %r11 = call std::Num<std::int>::from_int#impl:25eabc6b(%r9, %r1)
    %r12 = call std::Num<std::int>::sub#impl:6eee9827(%p0, %r1, %p1)
    %r13 = br b6
  b5:
    %r14 = alloca int
    %r15 = store int 1 to %r14
    %r16 = call std::Num<std::int>::from_int#impl:25eabc6b(%r14, %r0)
    %r17 = call std::Num<std::int>::neg#impl:6b873453(%r0, %p1)
    %r18 = br b6
  b6:
    %r19 = ret
"#
...
fn factorial() {
  ...
  b0:
    ...
    %r6 = call std::Num<std::int>::from_int#impl:25eabc6b(%r4, %r0)
  ...
  b2:
    ...
    %r14 = call std::Num<std::int>::from_int#impl:25eabc6b(%r12, %r1)
    %r15 = call std::Num<std::int>::sub#impl:6eee9827(%p0, %r1, %r11)
    %r16 = call <test>::factorial(%r11, %r2)
    %r17 = call std::Num<std::int>::mul#impl:a3604103(%p0, %r2, %p1)
    %r18 = br b4
  b3:
    %r19 = alloca int
    %r20 = store int 1 to %r19
    %r21 = call std::Num<std::int>::from_int#impl:25eabc6b(%r19, %p1)
    %r22 = br b4
  b4:
    %r23 = ret
"#
...
fn iter1_mut_local_copy() {
  ...
  b0:
    ...
    %r5 = call std::Num<std::int>::from_int#impl:25eabc6b(%r3, %r1)
    %r6 = call std::Num<std::int>::add#impl:7665d3ee(%r0, %r1, %r0)
    %r7 = memcpy %r0 to %p1
    %r8 = ret
"#,
    );
...
fn place_call_into_owned_local() {
  ...
  b0:
    ...
    %r10 = call std::Num<std::int>::from_int#impl:25eabc6b(%r8, %r1)
    %r11 = call std::Num<std::int>::add#impl:7665d3ee(%r0, %r1, %r0)
    %r12 = move %r0 to %p1
    %r13 = ret
"#,
    );
...
fn std::Value<[std::int]>::clone#impl:94a041f9(%p0: @arg & [int], %p1: @ret [int]):
  b0:
    %r0 = call std::Value<[A]>::clone#impl:d3305f1a(dict(m<...>:i16), dict(m<...>:i0), %p0, %p1)
    %r1 = ret

fn std::Value<[std::int]>::drop#impl:a4f41aeb(%p0: @arg &mut [int], %p1: @ret ()):
  b0:
    %r0 = call std::Value<[A]>::drop#impl:6cacf658(dict(m<...>:i16), dict(m<...>:i0), %p0, %p1)
    %r1 = ret

fn std::Value<[std::int]>::eq#impl:7e1688d4(%p0: @arg & [int], %p1: @arg & [int], %p2: @ret bool):
  b0:
    %r0 = call std::Value<[A]>::eq#impl:0ac782c1(dict(m<...>:i16), dict(m<...>:i0), %p0, %p1, %p2)
    %r1 = ret

fn std::Value<[std::int]>::hash#impl:0aca59c2(%p0: @arg & [int], %p1: @arg &mut hasher, %p2: @ret ()):
  b0:
    %r0 = call std::Value<[A]>::hash#impl:90d7c903(dict(m<...>:i16), dict(m<...>:i0), %p0, %p1, %p2)
    %r1 = ret

fn std::Value<[std::int]>::to_string#impl:892a091b(%p0: @arg & [int], %p1: @ret string):
  b0:
    %r0 = call std::Value<[A]>::to_string#impl:6a7dc628(dict(m<...>:i16), dict(m<...>:i0), %p0, %p1)
    %r1 = ret
"#,
    );
}
...
fn projection_of_place_call() {
  ...
  b0:
    ...
    %r5 = invoke std::array_index::ref_mut#subscript:cb69b6f4(%p0, %r2, %r4) -> b2 unwind b1
  b1:
    %r13 = drop %r0 via <test>::std::Value<(std::int, std::bool)>::drop#impl:2f5156cf
    %r14 = resume
  b2:
    %r6 = load %r4
    %r7 = call <test>::std::Value<(std::int, std::bool)>::clone#impl:c6a2252d(%r6, %r0)
    %r8 = subfield int 1 from %r0
    %r9 = memcpy %r8 to %r1
    %r10 = move %r1 to %p1
    %r11 = drop %r0 via <test>::std::Value<(std::int, std::bool)>::drop#impl:2f5156cf
    %r12 = ret

fn std::Value<(std::int, std::bool)>::clone#impl:c6a2252d(%p0: @arg & (int, bool), %p1: @ret (int, bool)):
  b0:
...
fn std::Value<(std::int, std::bool)>::eq#impl:8240623e(%p0: @arg & (int, bool), %p1: @arg & (int, bool), %p2: @ret bool):
  b0:
    %r0 = subfield int 0 from %p0
...
fn std::Value<(std::int, std::bool)>::hash#impl:d83c2054(%p0: @arg & (int, bool), %p1: @arg &mut hasher, %p2: @ret ()):
  b0:
    %r0 = subfield int 0 from %p0
    %r1 = alloca ()
...
fn std::Value<(std::int, std::bool)>::to_string#impl:8f2e215f(%p0: @arg & (int, bool), %p1: @ret string):
  b0:
    %r0 = alloca string
    %r1 = alloca string
    %r2 = alloca string
    ...
    %r11 = store ", " to %r2
    %r12 = alloca ()
    %r13 = call std::string_push_str(%r0, %r2, %r12)
    %r14 = drop %r2 via std::Value<std::string>::drop#impl:1d429675
    %r15 = subfield int 1 from %p0
    %r16 = call std::Value<std::bool>::to_string#impl:044f2674(%r15, %r3)
    %r17 = alloca ()
    %r18 = call std::string_push_str(%r0, %r3, %r17)
    %r19 = drop %r3 via std::Value<std::string>::drop#impl:1d429675
    %r20 = store ")" to %r4
    %r21 = alloca ()
    %r22 = call std::string_push_str(%r0, %r4, %r21)
    %r23 = drop %r4 via std::Value<std::string>::drop#impl:1d429675
    %r24 = move %r0 to %p1
    %r25 = ret
"#,
    );
...
fn mutable_reference_parameter() {
  ...
  b0:
    ...
    %r2 = call std::Num<std::int>::from_int#impl:25eabc6b(%r0, %p0)
    %r3 = store () to %p1
    %r4 = ret
"#,
    );
...
fn std::Value<(std::int,)>::to_string#impl:30b07f9c(%p0: @arg & (int,), %p1: @ret string):
  b0:
    ...
    %r5 = call std::Value<std::int>::to_string#impl:a5db1d9f(%r4, %r1)
    %r6 = alloca ()
    %r7 = call std::string_push_str(%r0, %r1, %r6)
    %r8 = drop %r1 via std::Value<std::string>::drop#impl:1d429675
    %r9 = store ")" to %r2
    %r10 = alloca ()
    %r11 = call std::string_push_str(%r0, %r2, %r10)
    %r12 = drop %r2 via std::Value<std::string>::drop#impl:1d429675
    %r13 = move %r0 to %p1
    %r14 = ret
"#,
    );
...
fn copy_int() {
  ...
  b0:
    ...
    %r4 = store int 1 to %r3
    %r5 = call std::Num<std::int>::from_int#impl:25eabc6b(%r3, %r1)
    %r6 = call std::Num<std::int>::add#impl:7665d3ee(%r0, %r1, %p1)
    %r7 = ret
"#,
    );
}
...
fn std::Value<<test>::A>::to_string#impl:78412598(%p0: @arg & A, %p1: @ret string):
  b0:
    ...
    %r13 = drop %r1 via std::Value<std::string>::drop#impl:1d429675
    %r14 = store ": " to %r2
    %r15 = alloca ()
    %r16 = call std::string_push_str(%r0, %r2, %r15)
    %r17 = drop %r2 via std::Value<std::string>::drop#impl:1d429675
    %r18 = subfield int 0 from %p0
    %r19 = call std::Value<std::int>::to_string#impl:a5db1d9f(%r18, %r3)
    %r20 = alloca ()
    %r21 = call std::string_push_str(%r0, %r3, %r20)
    %r22 = drop %r3 via std::Value<std::string>::drop#impl:1d429675
    %r23 = store ", " to %r4
    %r24 = alloca ()
    %r25 = call std::string_push_str(%r0, %r4, %r24)
    %r26 = drop %r4 via std::Value<std::string>::drop#impl:1d429675
    %r27 = store "y" to %r5
    %r28 = alloca ()
    %r29 = call std::string_push_str(%r0, %r5, %r28)
    %r30 = drop %r5 via std::Value<std::string>::drop#impl:1d429675
    %r31 = store ": " to %r6
    %r32 = alloca ()
    %r33 = call std::string_push_str(%r0, %r6, %r32)
    %r34 = drop %r6 via std::Value<std::string>::drop#impl:1d429675
    %r35 = subfield int 1 from %p0
    %r36 = call std::Value<std::int>::to_string#impl:a5db1d9f(%r35, %r7)
    %r37 = alloca ()
    %r38 = call std::string_push_str(%r0, %r7, %r37)
    %r39 = drop %r7 via std::Value<std::string>::drop#impl:1d429675
    %r40 = store " }" to %r8
    %r41 = alloca ()
    %r42 = call std::string_push_str(%r0, %r8, %r41)
    %r43 = drop %r8 via std::Value<std::string>::drop#impl:1d429675
    %r44 = move %r0 to %p1
    %r45 = ret
...
fn std::Value<<test>::Probe>::clone#impl:a879cee3(%p0: @arg & Probe, %p1: @ret Probe):
  b0:
    ...
    %r6 = call std::Num<std::int>::add#impl:7665d3ee(%r5, %r0, %r1)
    %r7 = ret
...
fn reassign_in_branches() {
  ...
  b2:
    ...
    %r8 = call std::Num<std::int>::from_int#impl:25eabc6b(%r6, %r0)
    %r9 = store () to %r1
    %r10 = br b4
  b3:
    %r11 = alloca int
    %r12 = store int 2 to %r11
    %r13 = call std::Num<std::int>::from_int#impl:25eabc6b(%r11, %r0)
    %r14 = store () to %r1
    %r15 = br b4
  b4:
    %r16 = move %r0 to %p1
...
fn named_subscript_compound_assign() {
  ...
  b0:
    ...
    %r1 = call <test>::first::ref_mut#subscript:19d196cf(%p0, %r0)
    %r2 = load %r0
    %r3 = call std::Num<std::int>::add#impl:7665d3ee(%r2, %p1, %r2)
    %r4 = store () to %p2
    %r5 = ret
...
fn f(%p0: @arg &mut int, %p1: @arg int, %p2: @ret ()):
  b0:
    %r0 = project <test>::cell::ref_mut#subscript:f3d0ec43(%p0)
    %r1 = call std::Num<std::int>::add#impl:7665d3ee(%r0, %p1, %r0)
    %r2 = store () to %p2
    %r3 = end_project %r0
    %r4 = ret
"#,
