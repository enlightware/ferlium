...
"#
  ...
  b0:
    br b1
  b1:
    %r0: bool = comp_eq %p0 0
    condbr %r0, b2, b3
  b2:
    memcpy %p0 to %p1
    br b6
  b3:
    %r1: bool = comp_eq %p0 1
    condbr %r1, b4, b5
  b4:
    %r2: place int = alloca int
    store @c0 to %r2
...
fn variant_match_switches_on_the_tag_register() {
    ...
    assert_eq_sans_flake!(
        session
            .emit_mir("fn a0(x: None | Some (int)) -> int { match x { None => 0, Some(v) => v } }"),
  ...
  b1:
    ...
    br b3
  b2:
    %r2: place (int,) = variant_payload from %p0
    %r3: place int = subfield @c0 from %r2
    memcpy %r3 to %p1
    br b3
  b3:
    ret
...
fn array_index_read() {
  ...
  @c3: int = 2
  b0:
    %r0: place bool = alloca bool
    %r1: place int = alloca int
    store @c0 to %r1
    %r2: place *bool = alloca_place bool
...
fn generic_apply() {
  ...
  b0:
    ...
    call %r2(%r3, %r0)
    call %r1(%p2, %r0, %p3)
    %r4: place ((&mut A) -> ()) = dict_entry 4 from %p1
    drop A %r0 via %r4
    ret
"#,
    );
...
#[test]
fn place_annotations_name_non_atomic_lowered_types_without_pointer_syntax() {
    let mut session = TestSession::new();
    ...
    assert!(out.contains("place (Left (int) | Right (bool)) = alloca Left (int) | Right (bool)"));
    assert!(out.contains(
        "place (subscript (&mut int) -> int { ref place; mut place }) = alloca subscript (&mut int) -> int { ref place; mut place }"
    ));
    assert!(out.contains("place (() -> int) = alloca () -> int"));
}
...
fn capture(%p0: @ret int):
  ...
  b0:
    ...
    %r3: place int = alloca int
    memcpy %r0 to %r3
    %r4: () -> int = build_closure <test>::$lambda$1(%r3, dict(<test>::std::Value<(std::int,)>))
    store %r4 to %r1
    call %r1(%p0)
...
fn std::Value<(std::int,)>::eq#impl:b00d2abd(%p0: @arg let (int,), %p1: @arg let (int,), %p2: @ret bool):
  ...
  @c2: bool = false
  b0:
    %r0: place int = subfield @c0 from %p0
    %r1: place int = subfield @c0 from %p1
    %r2: place bool = alloca bool
...
fn std::Value<(std::int,)>::to_string#impl:30b07f9c(%p0: @arg let (int,), %p1: @ret string):
  ...
  @c3: StaticStr = ")"
  b0:
    %r0: place string = alloca string
    %r1: place string = alloca string
    %r2: place StaticStr = alloca StaticStr
    store @c0 to %r2
    call std::string_from_static(%r2, %r0)
    %r3: place int = subfield @c2 from %p0
    ...
    %r5: place StaticStr = alloca StaticStr
    store @c3 to %r5
    %r6: place () = alloca ()
...
fn generic_multiple_ops_reuse_witness() {
  ...
  b0:
    ...
    call %r2(%p2, %p2, %r0)
    call %r1(%r0, %p2, %p3)
    %r3: place ((&mut A) -> ()) = dict_entry 4 from %p1
    drop A %r0 via %r3
    ret
"#,
    );
...
fn construct_struct() {
  ...
  b0:
    ...
    store @c1 to %r1
    call std::Num<std::int>::from_int#impl:25eabc6b(%r1, %r0)
    %r2: place int = subfield @c1 from %p0
    %r3: place int = alloca int
    store @c2 to %r3
...
fn make_wrapper(%p0: @ret Wrapper):
  ...
  @c1: int = 1
  b0:
    %r0: place A = subfield @c0 from %p0
    call <test>::make_a(%r0)
    %r1: place A = subfield @c1 from %p0
    call <test>::make_a(%r1)
    ret
...
fn std::Value<<test>::A>::eq#impl:601557a9(%p0: @arg let A, %p1: @arg let A, %p2: @ret bool):
  ...
  b1:
    ...
    condbr %r3, b2, b3
  b2:
    %r4: place int = subfield @c1 from %p0
    %r5: place int = subfield @c1 from %p1
    %r6: place bool = alloca bool
...
fn std::Value<<test>::A>::to_string#impl:78412598(%p0: @arg let A, %p1: @ret string):
  ...
  b0:
    ...
    %r18: place StaticStr = alloca StaticStr
    store @c8 to %r18
    %r19: place () = alloca ()
...
fn std::Value<<test>::Wrapper>::eq#impl:d6883255(%p0: @arg let Wrapper, %p1: @arg let Wrapper, %p2: @ret bool):
  ...
  b0:
    %r0: place A = subfield @c0 from %p0
    %r1: place A = subfield @c0 from %p1
    %r2: place bool = alloca bool
  ...
  b1:
    ...
    condbr %r3, b2, b3
  b2:
    %r4: place A = subfield @c1 from %p0
    %r5: place A = subfield @c1 from %p1
    %r6: place bool = alloca bool
...
fn std::Value<<test>::Wrapper>::hash#impl:65f26de7(%p0: @arg let Wrapper, %p1: @arg &mut hasher, %p2: @ret ()):
  ...
  b0:
    ...
    %r2: place A = subfield @c1 from %p0
    %r3: place () = alloca ()
...
fn std::Value<<test>::Wrapper>::to_string#impl:7f6f6750(%p0: @arg let Wrapper, %p1: @ret string):
  ...
  b0:
    ...
    %r7: place () = alloca ()
    call std::string_push_static_str(%r0, %r6, %r7)
    %r8: place A = subfield @c4 from %p0
    ...
    %r15: place () = alloca ()
    call std::string_push_static_str(%r0, %r14, %r15)
    %r16: place A = subfield @c7 from %p0
...
fn clone_value_generic_branch() {
  ...
  b2:
    ...
    br b4
  b3:
    %r2: place ((A) -> A) = dict_entry 3 from %p0
...
fn store_local_generic_clone_dictionary() {
  ...
  b0:
    ...
    call <test>::g(%r0, %r2)
    store @c0 to %p2
    %r3: place ((&mut A) -> ()) = dict_entry 4 from %p0
    drop A %r0 via %r3
    ret
...
fn generic_match_nested_composite_scrutinee_compares_whole_value() {
  ...
  b0:
    br b1
  b1:
    %r0: bool = comp_eq %p0 (true, (false, true))
    condbr %r0, b2, b3
  b2:
    %r1: place int = alloca int
    store @c0 to %r1
...
fn discarded_tuple_construction_lowers_into_throwaway_temp() {
  ...
  @c1: int = 1
  b0:
    %r0: place (int, int) = alloca (int, int)
    %r1: place int = subfield @c0 from %r0
    memcpy %p0 to %r1
    %r2: place int = subfield @c1 from %r0
    memcpy %p0 to %r2
    memcpy %p0 to %p1
    ret
"#,
...
fn discarded_record_construction_lowers_into_throwaway_temp() {
  ...
  @c1: int = 1
  b0:
    %r0: place { a: int, b: int } = alloca { a: int, b: int }
    %r1: place int = subfield @c0 from %r0
    memcpy %p0 to %r1
    %r2: place int = subfield @c1 from %r0
    memcpy %p0 to %r2
...
/// Role annotation is what separates `alloca` from `alloca_place`: one slot holds an `int`, the
/// other holds a pointer to one, and the `load` that reads the second yields the pointer as a
/// value. All three are just `%rN` without it.
#[test]
fn role_annotation_distinguishes_a_place_slot_from_a_value_slot() {
    let mut session = TestSession::new();

    assert_eq_sans_flake!(
        session.emit_mir("fn a0(a: [int], i: int) -> int { a[i] }"),
